  ...
  for sub_dir in sub_dirs:
    ...
    for file_name in file_list:
      ...
      if percentage_hash < validation_percentage:
        degrees = 0
        while (degrees < 360):
            validation_images.append(base_name+"_"+str(degrees)+".jpeg")
            degrees = degrees + 30
      elif percentage_hash < (testing_percentage + validation_percentage):
        degrees = 0
        while (degrees < 360):
            testing_images.append(base_name+"_"+str(degrees)+".jpeg")
            degrees = degrees + 30
      else:
        degrees = 0
        while (degrees < 360):
            training_images.append(base_name+"_"+str(degrees)+".jpeg")
            degrees = degrees + 30
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='tf_files/training_summaries/'+ARCHITECTURE,
  ...
  parser.add_argument(
      '--model_dir',
      type=str,
      default='tf_files/models/'+ARCHITECTURE,
      help="""\
